...
- **Implementation approach**: 45 WebMCP tools across keymap, lighting/RGB, macros, layout, devices, diagnostics, and app settings, all calling the same Redux thunks and `KeyboardAPI` (raw HID) methods the human-facing UI already used, with no parallel code path and no stubs.
...
<img src="./public/remap-icon.png" alt="remap" width="140" />
